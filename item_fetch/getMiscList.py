...
start = 5000 #CHANGE MANUALLY HERE IF ERRORS
while(True):
    URL = f"https://steamcommunity.com/market/search/render/?search_descriptions=0&sort_column=name&sort_dir=desc&appid=730&norender=1&start={start}&count=100&category_730_ItemSet[]=any&category_730_ProPlayer[]=any&category_730_StickerCapsule[]=any&category_730_TournamentTeam[]=any&category_730_Weapon[]=any&category_730_Rarity[]=any&category_730_Type[]=tag_CSGO_Type_WeaponCase&category_730_Type[]=tag_Type_CustomPlayer&category_730_Type[]=tag_CSGO_Tool_Sticker&category_730_Type[]=tag_CSGO_Type_Spray&appid=730"
